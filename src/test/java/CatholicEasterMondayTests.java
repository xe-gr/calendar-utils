...
public class CatholicEasterMondayTests {

    @Parameterized.Parameters
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { 2018, LocalDate.of(2018, 4, 2) },
                { 2019, LocalDate.of(2019, 4, 22) },
                { 2020, LocalDate.of(2020, 4, 13) },
        });
    }
    ...
    public CatholicEasterMondayTests(int input, LocalDate expected) {
        this.input = input;
    ...
    public void VerifyDates() {
        ...
        assertEquals(expected, holidays.getCatholicEasterMonday());
    }
}
